...
public class CountAction extends TemporalAction {
    ...
    public static CountAction Get(GDX.Runnable<Float> onUpdate, float start, float end, float duration, Interpolation interpolation)
    {
    ...
    public static CountAction Get(GDX.Runnable<Float> onUpdate, float start, float end, float duration)
    {
